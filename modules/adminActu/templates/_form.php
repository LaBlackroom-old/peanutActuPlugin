...
<div class="sf_admin_form">
  ...
  <?php echo form_tag_for($form, '@peanut_actu') ?>
    ...
    <?php include_partial('adminActu/form_actions', array('peanut_page' => $peanut_actu, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </form>
</div>